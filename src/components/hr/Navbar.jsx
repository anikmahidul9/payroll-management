      ...
      <div className="mx-auto flex h-16 max-w-screen-2xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-xl font-bold text-gray-800 tracking-wider hidden sm:block">
            <span className="text-indigo-600">HR</span>Panel
          </h1>
        </div>
          ...
          <div className="relative">
            ...
            >
              ...
              <div className="hidden md:block text-left">
                <p className="text-sm font-medium text-gray-800">Eric Frusciante</p>
            ...
            >
              ...
              >
                <div className="border-b border-gray-200 px-4 py-3">
                  <p className="text-sm font-semibold text-gray-800">Eric Frusciante</p>
                  <p className="text-xs text-gray-500 truncate">eric@frusciante.com</p>
                </div>
                <div className="py-1">
                  <a
                    href="#"
